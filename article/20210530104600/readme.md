...
--date 日期格式�?
--stat	显示每次更新的文件修改统计信�?
--shortstat	只显�? --stat 中最后的行数修改添加移除统计
--name-only	仅显示已修改的文件清�?
--name-status	显示新增、修改�?�删除的文件清单
--abbrev-commit	仅显�? SHA-1 的前9个字符，而非�?有的 40 个字�?
--relative-date	使用较短的相对时间显示（比如，�??2 days ago”）
--graph	显示 ASCII 图形表示的分支合并历�?
--since/after 显示提交比指定日期更�?
--until/before 显示早于特定日期的提�?
...
-20 �?近二十次提交记录，无则表示导出所有记录到log.txt
...
%an	作�?�（author）的名字
%ae	作�?�的电子邮件地址
%ad	作�?�修订日期（可以�? -date= 选项定制格式�?
%ar	作�?�修订日期，按多久以前的方式显示
%cn	提交�?(committer)的名�?
%ce	提交者的电子邮件地址
%cd	提交日期
%cr	提交日期，按多久以前的方式显�?
...
%a 星期（缩写）：Sat
%b 月份（缩写）：Apri
%c 格式化输出日期时�? �?/�?/�? �?:�?:秒：04/25/20 18:21:01
%d 日期�?25
%j �?年的第几天：116
%m 月份数字�?04
%p 上下午：AM/PM
...
%M 分钟�?21
%S 秒：01
%U �?年的第几周（星期日作为每周的第一天）�?16
%W �?年的第几周（星期�?作为每周的第�?天）�?16
%X 格式化输出短时间�?18:21:01
%Y 年份�?2020
%Z 时区�?+0800 
