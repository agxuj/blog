...
checkout
````
### git还有�?个强悍的功能，对过往的commit进行删除或�?�修�?
`````
rebase
`````
...
[head/master/分支 间的关系可以�? --- 理解git中的head和master](https://blog.csdn.net/bdss58/article/details/40537859)

[git中的origin -- 只想服务端仓库的标志](https://blog.csdn.net/niexia_/article/details/79422859)

#### detached head
如果让HEAD文件指向�?个commit id而不是具体分支，那就变成了detached HEAD�? 
...
[Git 中的 ~ �? ^](https://www.2cto.com/kf/201807/758347.html)